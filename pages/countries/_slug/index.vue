<template>
  <div v-if="country" class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    ...
    <div class="flex flex-wrap-reverse md:flex-nowrap md:flex-row space-x-0 md:space-x-6">
      <div class="flex flex-col justify-center w-full md:w-1/2">
        <div class="max-w-xl mb-6">
          <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-primary-700 sm:text-4xl sm:leading-none">
           {{ country.name }}
          </h2>
        </div>
